...
public class GoogleDocsDemo {
    ...
    public static void main(String[] args) {
        ...
        Step03_GoogleDocsEventBus eventBus = new Step03_GoogleDocsEventBus();
        ...
        eventBus.subscribe(spannerDb);
        eventBus.subscribe(syncLayer);
        eventBus.subscribe(aiGrammar);

        System.out.println("--- User Types 'Hello' ---");
        // User types 'H'
        eventBus.publishEdit(new Step01_DocumentEditEvent("DOC-123", "alice@gmail.com", "H", 0, Instant.now()));
        ...
        eventBus.unsubscribe(aiGrammar);
        
        // User types 'e'
        eventBus.publishEdit(new Step01_DocumentEditEvent("DOC-123", "alice@gmail.com", "e", 1, Instant.now()));
