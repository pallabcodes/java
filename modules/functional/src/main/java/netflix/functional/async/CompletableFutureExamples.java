...
public class CompletableFutureExamples {
    ...
    public static void demonstrateCompletableFutureCreation() {
        ...
        CompletableFuture<String> supplier = CompletableFuture.<String>supplyAsync(() -> {
        ...
        CompletableFuture<String> customExecutorFuture = CompletableFuture.<String>supplyAsync(() -> {
        ...
        CompletableFuture<String> delayed = CompletableFuture.<String>supplyAsync(() -> {
            try {
                Thread.sleep(1000);
    ...
    public static void demonstrateAsyncComposition() {
        ...
        CompletableFuture<String> future1 = CompletableFuture.<String>supplyAsync(() -> "Hello")
                .thenApply(s -> s + " World")
                .thenApply(String::toUpperCase);
        log.debug("Basic composition: {}", future1.join());
        
        // Composition with thenCompose
        CompletableFuture<String> future2 = CompletableFuture.<String>supplyAsync(() -> "Hello")
                .thenCompose(s -> CompletableFuture.<String>supplyAsync(() -> s + " World"))
                .thenCompose(s -> CompletableFuture.<String>supplyAsync(() -> s + "!"));
        log.debug("Compose composition: {}", future2.join());
        
        // Composition with thenCombine
        CompletableFuture<String> future3 = CompletableFuture.<String>supplyAsync(() -> "Hello")
                .thenCombine(CompletableFuture.<String>supplyAsync(() -> "World"), (s1, s2) -> s1 + " " + s2)
                .thenApply(String::toUpperCase);
        log.debug("Combine composition: {}", future3.join());
        
        // Composition with thenAccept
        CompletableFuture<Void> future4 = CompletableFuture.<String>supplyAsync(() -> "Hello World")
                .thenApply(String::toUpperCase)
                .thenAccept(s -> log.debug("Accepted: {}", s));
        future4.join();
        
        // Composition with thenRun
        CompletableFuture<Void> future5 = CompletableFuture.<String>supplyAsync(() -> "Hello World")
                .thenApply(String::toUpperCase)
                .thenRun(() -> log.debug("Running after completion"));
        future5.join();
        
        // Composition with handle
        CompletableFuture<String> future6 = CompletableFuture.<String>supplyAsync(() -> "Hello World")
                .handle((res, throwable) -> {
                    if (throwable != null) {
                        log.debug("Operation error with handle: {}", throwable.getMessage());
        ...
        CompletableFuture<String> future7 = CompletableFuture.<String>supplyAsync(() -> "Hello World")
                .whenComplete((res, throwable) -> {
                    if (throwable != null) {
                        log.debug("Error occurred: {}", throwable.getMessage());
                    } else {
                        log.debug("Completed successfully: {}", res);
                    }
                });
    ...
    public static void demonstrateExceptionHandling() {
        ...
        CompletableFuture<String> future1 = CompletableFuture.<String>supplyAsync(() -> {
            throw new RuntimeException("Test error");
        }).<String>handle((res, throwable) -> {
            if (throwable != null) {
        ...
        CompletableFuture<String> future4 = CompletableFuture.<String>supplyAsync(() -> {
            throw new RuntimeException("Test error");
        }).<String>handle((res, throwable) -> {
            if (throwable != null) {
    ...
    public static void demonstrateParallelExecution() {
        ...
        CompletableFuture<String> future1 = CompletableFuture.<String>supplyAsync(() -> "Hello");
        CompletableFuture<String> future2 = CompletableFuture.<String>supplyAsync(() -> "World");
        CompletableFuture<String> future3 = CompletableFuture.<String>supplyAsync(() -> "!");
        ...
        List<CompletableFuture<String>> futures = Arrays.asList(
                CompletableFuture.<String>supplyAsync(() -> "Hello"),
                CompletableFuture.<String>supplyAsync(() -> "World"),
        ...
        List<CompletableFuture<String>> customFutures = Arrays.asList(
                CompletableFuture.<String>supplyAsync(() -> "Hello", customExecutor),
                CompletableFuture.<String>supplyAsync(() -> "World", customExecutor),
                CompletableFuture.<String>supplyAsync(() -> "!", customExecutor)
        );
    ...
    public static void demonstrateCustomThreadPools() {
        ...
        CompletableFuture<String> future2 = CompletableFuture.<String>supplyAsync(() -> "Hello", customPool)
                .thenApplyAsync(s -> s + " World", customPool)
                .thenApplyAsync(String::toUpperCase, customPool);
        log.debug("Custom pool result: {}", future2.join());
        
        // Future with custom thread pool and exception handling
        CompletableFuture<String> future3 = CompletableFuture.<String>supplyAsync(() -> {
            throw new RuntimeException("Test error");
        }, customPool).<String>handle((res, throwable) -> {
            if (throwable != null) {
    ...
    public static void demonstratePerformanceOptimization() {
        ...
        CompletableFuture<String> sequential = CompletableFuture.<String>supplyAsync(() -> "Hello")
                .thenApply(s -> s + " World")
                .thenApply(String::toUpperCase);
        ...
        CompletableFuture<String> parallel1 = CompletableFuture.<String>supplyAsync(() -> "Hello");
        CompletableFuture<String> parallel2 = CompletableFuture.<String>supplyAsync(() -> "World");
        ...
        CompletableFuture<String> customExecutorFuture = CompletableFuture.<String>supplyAsync(() -> "Hello", customExecutor)
        ...
        log.debug("Custom executor result: {}", customExecutorFuture.join());
        
        // Performance with monitoring
        CompletableFuture<String> monitored = CompletableFuture.<String>supplyAsync(() -> {
    ...
    public static void demonstrateStreamIntegration() {
        ...
        List<CompletableFuture<String>> futures = inputs.stream()
                .map(input -> CompletableFuture.<String>supplyAsync(() -> input.toUpperCase()))
                .collect(Collectors.toList());
        ...
        List<String> customExecutorResults = inputs.stream()
                .map(input -> CompletableFuture.<String>supplyAsync(() -> input.toUpperCase(), customExecutor))
                .map(CompletableFuture::join)
                .collect(Collectors.toList());
        ...
        List<String> errorHandledResults = inputs.stream()
                .map(input -> CompletableFuture.<String>supplyAsync(() -> {
                    if (input.equals("Java")) {
                        throw new RuntimeException("Test error");
                    }
                    return input.toUpperCase();
                }))
                .map(future -> future.<String>handle((res, throwable) -> {
                    if (throwable != null) {
                        log.debug("Error occurred: {}", throwable.getMessage());
                        return "Error";
                    }
    ...
    public static void demonstrateErrorHandlingAndResilience() {
        ...
        CompletableFuture<String> circuitBreaker = CompletableFuture.<String>supplyAsync(() -> {
        ...
        // Fallback pattern
        CompletableFuture<String> fallback = CompletableFuture.<String>supplyAsync(() -> {
        ...
        // Timeout pattern
        CompletableFuture<String> timeout = CompletableFuture.<String>supplyAsync(() -> {
            try {
                Thread.sleep(2000);
            } catch (InterruptedException e) {
                Thread.currentThread().interrupt();
        ...
        // Bulkhead pattern
        CompletableFuture<String> bulkhead = CompletableFuture.<String>supplyAsync(() -> {
            log.debug("Executing in bulkhead");
            return "Bulkhead result";
        }, customExecutor).<String>handle((res, throwable) -> {
            if (throwable != null) {
                log.debug("Execution error: {}", throwable.getMessage());
    ...
    public static void demonstrateTestingAndDebugging() {
        ...
        CompletableFuture<String> async = CompletableFuture.<String>supplyAsync(() -> "Hello World");
        assert !async.isDone();
        ...
        CompletableFuture<String> composed = CompletableFuture.<String>supplyAsync(() -> "Hello")
                .thenApply(s -> s + " World")
                .thenApply(String::toUpperCase);
        assert composed.join().equals("HELLO WORLD");
        
        // Test with exception handling
        CompletableFuture<String> exceptionHandled = CompletableFuture.<String>supplyAsync(() -> {
            throw new RuntimeException("Test error");
        }).<String>handle((res, throwable) -> {
            if (throwable != null) {
                return "Error handled";
    ...
    public static void demonstrateProductionBestPractices() {
        ...
        CompletableFuture<String> timeoutHandled = CompletableFuture.<String>supplyAsync(() -> {
            try {
                Thread.sleep(2000);
            } catch (InterruptedException e) {
                Thread.currentThread().interrupt();
            ...
            return "Slow result";
                ...
                .<String>handle((res, throwable) -> {
                    if (throwable != null) {
                        log.error("Service timeout or error: {}", throwable.getMessage());
        ...
        CompletableFuture<String> customPool = CompletableFuture.<String>supplyAsync(() -> {
            log.debug("Executing in custom thread pool");
            return "Custom pool result";
        }, customExecutor).<String>handle((result, throwable) -> {
            if (throwable != null) {
        ...
        CompletableFuture<String> monitored = CompletableFuture.<String>supplyAsync(() -> {
            ...
            log.debug("Monitored execution completed: {}", res);
            return res;
        });
        log.debug("Monitored result: {}", monitored.join());
    }
