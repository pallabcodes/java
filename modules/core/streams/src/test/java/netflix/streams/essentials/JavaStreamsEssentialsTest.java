...
class JavaStreamsEssentialsTest {
    ...
    @Test
    @DisplayName("Should throw NullPointerException for null stream")
    ...
    @Test
    @DisplayName("Should throw NullPointerException for null batch processor")
    ...
    @Test
    @DisplayName("Should throw NullPointerException for null classifier")
    ...
    @Test
    @DisplayName("Should throw NullPointerException for null value mapper")
    ...
    void testCreatePartitioningCollector_WithExceptions() {
        ...
        var collector = JavaStreamsEssentials.<String>createPartitioningCollector(s -> s.length() > 4);
    ...
    @Test
    @DisplayName("Should throw NullPointerException for null predicate")
