...
class NetflixMathLibraryIntegrationTest {
    ...
    void testCombinatoricsWorkflow() {
        ...
        assertEquals(BigInteger.valueOf(55), fib10);
        ...
        assertEquals(BigInteger.valueOf(10), comb52);
        assertEquals(BigInteger.valueOf(20), perm52);

        // Catalan numbers
        var catalan3 = comb.catalanNumber(3);
        System.out.println("Catalan number C_3 = " + catalan3);
        assertEquals(BigInteger.valueOf(5), catalan3);
    }
    ...
    void testPerformanceAndScalability() {
        ...
        assertTrue(largeComb.compareTo(BigInteger.ZERO) > 0);
