...
public class AdvancedFunctionalInterfaces {
    ...
    public static void demonstrateMethodReferences() {
        ...
        String result = stringConstructor.apply("Hello", "World");
    ...
    public static void demonstrateHigherOrderFunctions() {
        ...
        Function<String, String> prefixTransformer = createTransformer.apply(s -> "Hello, " + s);
        
        log.debug("Upper transformer: {}", upperTransformer.apply("world"));
        log.debug("Prefix transformer: {}", prefixTransformer.apply("world"));
    }
